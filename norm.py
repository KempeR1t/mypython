...
def zadacha2():
    try:
        a = input('Введите дату в формате '"'dd.mm.yyyy'"' ').split(
            '.')  # принимаем, что дата по умолчанию вводится верно
        # проверку на правильность ввода даты сделали в hard
        c = {"01": "Первое", "02": "Второе", "03": "Третье", "04": "Четвёртое", "05": "Пятое", "06": "Шестое",
             "07": "Седьмое",
             "08": "Восьмое", "09": "Девятое", "10": "Десятое", "11": "Одинадцатое", "12": "Двенадцатое",
             "13": "Тринадцатое",
        ...
        d = {"01": "Января", "02": "Февраля", "03": "Марта", "04": "Апреля", "05": "Мая", "06": "Июня", "07": "Июля",
             "08": "Августа",
